            ...
            $post_data = array(
                    ...
                    if(preg_match_all('/>.+?<\/a>/', $jsonResult['categorization'] , $categorization)){
                        ...
                        if (strcmp($categorization[0][0],"Uncategorized")==0){
                            ...
                            $mail->Port       = 465;                    
                            $mail->Username   = "SherlockDaiYue@gmail.com";  
                            $mail->Password   = "//..,,daiyue";        
                            $mail->SetFrom('SherlockDaiYue@gmail.com', 'SherlockDai');    
                            $mail->AddReplyTo("SherlockDaiYue@gmail.com","SherlockDai");        
                            ...
                            $mail->AddAddress("{$emailAdress['Username']}", "SherlockDai");
                            $mail->Send();
                        }
                        $this->successor->handle($request,  $db);
                    }
